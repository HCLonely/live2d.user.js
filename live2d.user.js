...
(function($) {
    ...
    function initModel(waifuPath, type) {
        ...
        console.log("%c "+{"msg":"\n\nく__,.ヘヽ.　　　　/　,ー､ 〉\n　　　　　＼ ', !-─‐-i　/　/´\n　　　 　 ／｀ｰ'　　　 L/／｀ヽ､\n　　 　 /　 ／,　 /|　 ,　 ,　　　 ',\n　　　ｲ 　/ /-‐/　ｉ　L_ ﾊ ヽ!　 i\n　　　 ﾚ ﾍ 7ｲ｀ﾄ ﾚ'ｧ-ﾄ､!ハ|　 |\n　　　　 !,/7 '0'　　 ´0iソ| 　 |\n　　　　 |.从\"　　_　　 ,,,, / |./ 　 |\n　　　　 ﾚ'| i＞.､,,__　_,.イ / 　.i 　|\n　　　　　 ﾚ'| | / k_７_/ﾚ'ヽ,　ﾊ.　|\n　　　　　　 | |/i 〈|/　 i,.ﾍ |　i|\n　　　　　　.|/ /　ｉ： 　 ﾍ!　　＼|\n　　　 　 　 kヽ>､ﾊ 　 _,.ﾍ､ 　 /､!\n　　　　　　 !'〈//｀Ｔ´', ＼ ｀'7'ｰr'\n　　　　　　 ﾚ'ヽL__|___i,___,ンﾚ|ノ\n　　　　　 　　　ﾄ-,/　|___./\n　　　　　 　　　'ｰ'　　!_,.:\nLive2D 看板娘 v1.4.2 / FGHRSH 2018.11.12\n"}.msg,"color:#ff3d3d");
        ...
        if(live2d_settings.waifuDraggableSave&&GM_getValue("waifuPosition")){
            let position=GM_getValue("waifuPosition");
    ...
    function loadTipsMessage(result) {
        ...
        function showHitokoto(e=false) {
            let api=e||live2d_settings.hitokotoAPI;
            switch(api) {
                case 'lwl12.com':
                    GM_xmlhttpRequest({
                        method: "GET",
                ...
                case 'hitokoto.cn':
                    ...
                    break;
                default:
                    let hitokotoApiArr=['lwl12.com','fghrsh.net','jinrishici.com','hitokoto.cn'];
            ...
            for (var i = new l, e = c.getPlatformManager(), r = e.jsonParseFromBytes(t), o = r.physics_hair, n = o.length, s = 0; s < n; s++) {
                ...
                for (var f = _.src, d = f.length, g = 0; g < d; g++) {
                    var y = f[g],
                        ...
                        P = y.ptype;
                    "x" === P ? T = PhysicsHair.Src.SRC_TO_X : "y" === P ? T = PhysicsHair.Src.SRC_TO_Y : "angle" === P ? T = PhysicsHair.Src.SRC_TO_G_ANGLE : UtDebug("live2d", "Invalid parameter:PhysicsHair.Src");
	...
	default.PRIORITY_NORMAL));
            ...
            o.prototype = new n.L2DBaseModel, o.prototype.load = function(t, i, e) {
                ...
                if (this.mainMotionManager.isFinished()) {
                    "1" === GM_getValue("Sleepy") ? this.startRandomMotion(h.
    ...
    let code='38|38|40|40|37|39|37|39|66|65|66|65';
    let unCode='69|83|67';
    let hideCode='72|73|68|69';
    let showCode='83|72|79|87';
