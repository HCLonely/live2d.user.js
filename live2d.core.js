...
live2d_settings = GM_getValue('live2d_settings') || { ...live2d_conf }
...
!(function (t) {
  ...
  r.prototype.loadBytes = function (t, i) {
    ...
    if (live2d_settings.modelAPI === 'default') {
      if (/id=[\d]+-[\d]+/.test(t)) {
        ...
        if (Array.isArray(modelList[parseInt(modelId) - 1])) {
          url = 'https://cdn.jsdelivr.net/gh/hclonely/live2d.user.js@' + VERSION + '/models/' + modelList[parseInt(modelId) - 1][(modelTexturesId === '0' ? 1 : parseInt(modelTexturesId)) - 1]
        } else {
          url = 'https://cdn.jsdelivr.net/gh/hclonely/live2d.user.js@' + VERSION + '/models/' + modelList[parseInt(modelId) - 1]
        }
      } else {
        url = t.replace('defaultget', 'https://cdn.jsdelivr.net/npm')
      }
    } else {
    ...
    let url = ''
    if (live2d_settings.modelAPI === 'default') {
      url = e.replace('defaultget', 'https://cdn.jsdelivr.net/npm')
    } else {
