...
- 后端接口
  ...
  - `live2d_settings['modelAPI']`：看板娘 API 地址，默认值 `'https://live2d.hclonely.com/'`，备用值 `'https://live2d.fghrsh.net/api/'`
  - `live2d_settings['staticAPI']`：看板娘 API 地址，默认值 `'https://model.hclonely.com'`，备用值 `'https://live2d.fghrsh.net/api/'`
